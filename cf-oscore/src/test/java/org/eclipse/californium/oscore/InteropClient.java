...
public class InteropClient {
	...
	public static void main(String[] args) throws OSException {
		...
		//Avoid CoAP retransmissions (should not be needed except to speed up Test_14a)
		NetworkConfig config = NetworkConfig.getStandard();
		config.setInt(NetworkConfig.Keys.MAX_RETRANSMIT, 0);
		//Set ACK timeout to be 4 seconds
		config.setInt(NetworkConfig.Keys.ACK_TIMEOUT, 4000);
		
		
		TEST_17a(); //Test to run
	}
	...
	//Note that this test must be ran against server without OSCORE support
